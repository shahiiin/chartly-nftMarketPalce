...
const features = [
  {
    name: "Transparency",
    description:
      "Web3 is about transparent world and communication, specially in financial activities.",
    icon: CloudUploadIcon,
  },
  {
    name: "Trust Based",
    description:
      "Transparency can assure Trust, an open ecosystem is more reliable.",
    icon: LockClosedIcon,
  },
  {
    name: "Community Proof",
    description:
      "Community Driven Ecosystem gives power to the engaged people and they decide about it",
    icon: RefreshIcon,
  },
  {
    name: "Open to NGOs",
  ...
  },
  {
    name: "NFT Power",
    description:
      "We incentivize good acts by donating Non-Fungible Tokens, Users can earn this badges as a proof for social benefit tasks.",
    icon: CogIcon,
  },
  {
    name: "Corporate Social Responsibilites",
    description:
      "We offer CSR packages for corporate users and help others on behalf of the corporations",
    icon: ServerIcon,
  },
];
const blogPosts = [
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                  <div className="lg:py-24">
                    ...
                    >
                      ...
                      <span className="ml-4 text-sm">Read Our WhitePaper</span>
                      <ChevronRightIcon
                    ...
                    <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                      <span className="block">Blockchain Defacto</span>
                      <span className="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">
                        For Charities
                      </span>
                    </h1>
                    <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                      Cultchain is a blockchain based charity which aims to
                      bring transparency and Trust to Charities and NGOs.
                    </p>
                  </div>
                </div>
            ...
            <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
              <div>
                ...
                <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                  Donors and Vulenteers Are Great Part of Todays Culture, We
                  Like to Incentivize Them in a Very Modern Way, in Blockhcian
                  Way.
                </p>
              </div>
